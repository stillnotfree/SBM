...
регенерация HWID доступны отдельно; при обновлении подписки или приложения он
никогда не ротируется автоматически.
...
Версия 1.1.10 включает зафиксированное стабильное ядро sing-box 1.13.16 и не
